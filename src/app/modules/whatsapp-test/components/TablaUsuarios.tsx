    ...
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        >
          {/* Nombre Completo*/}
          <TableSortLabel
            active={orderBy === "NOMBRE_SESSION"}
            direction={orderBy === "NOMBRE_SESSION" ? order : 'asc'}
            onClick={createSortHandler("NOMBRE_SESSION")}
          >
            NOMBRE SESSION
            {orderBy === "NOMBRE_SESSION" ? (
...
export default function TablaUsuarios(props: any) {
  ...
  const pasarParametrosDetalle = (row: any) => {
