...
//const rows = 'calories';
const DEFAULT_ORDER_BY = 'ID_VENTAS_PERFIL';
    ...
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        >
          {/* Nombre Completo*/}
          <TableSortLabel
            active={orderBy === "ID_VENTAS_PERFIL"}
            direction={orderBy === "ID_VENTAS_PERFIL" ? order : 'asc'}
            onClick={createSortHandler("ID_VENTAS_PERFIL")}
          >
            Id
            {orderBy === "ID_VENTAS_PERFIL" ? (
        ...
        >
          ...
          <TableSortLabel
            ...
            onClick={createSortHandler("PERFIL")}
          >
            Nombre de Perfil
            {orderBy === "PERFIL" ? (
              <Box component="span" sx={visuallyHidden}>
...
export default function TablaPerfil(props: any) {
 ...
 //modal--->
  ...
  const { tableData, deleteByIndex, loadObtenerListaPerfil }: any = props;
  ...
  return (
    <div>
                ...
                return (
                  <TableRow key={index}>
                    ...
                    <TableCell
                      ...
                      align="left"
                    >
                      <Button sx={{ fontSize: 35,color: 'orange' }} 
      ...
      <ModalEditarPerfil
        ...
        loadObtenerListaPerfil={loadObtenerListaPerfil}
