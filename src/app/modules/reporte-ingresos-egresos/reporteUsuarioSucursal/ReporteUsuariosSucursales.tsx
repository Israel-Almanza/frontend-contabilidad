...
import TablaRepUsuarioSucursal from './TablaRepUsuarioSucursal';
...
import { useRepUsuarioSucursalServices } from './services/useRepUsuarioSucursalServices';
...
const RepUsuarioSucursal = () => {

    const { loadApiListaTipoReporte } = useRepUsuarioSucursalServices();
...
export default RepUsuarioSucursal