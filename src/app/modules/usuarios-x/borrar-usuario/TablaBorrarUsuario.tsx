    ...
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        <TableCell sx={{ ...tableStyling, width: '5%' }} align="left">
          Ubicaciones
          <TableSortLabel
            active={orderBy === "SUCURSALES"}
            direction={orderBy === "SUCURSALES" ? order : 'asc'}
            onClick={createSortHandler("SUCURSALES")}
          >
            {/*headCell.label*/}
            {orderBy === "SUCURSALES" ? (
              <Box component="span" sx={visuallyHidden}>
...
export default function TablaBorrarUsuario(props: any) {

  //console.log("rec prodiedad ", props.lista)
  const { tableData, deleteByIndex, loadgetUsuariosconBaja }: any = props;
