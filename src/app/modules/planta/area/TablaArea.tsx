...
import { ModalActivarArea } from "./components/ModalActivar";
import { ModalDesactivarArea } from "./components/ModalDesactivar";
...
//const rows = 'calories';
const DEFAULT_ORDER_BY = 'ID_AREA';
    ...
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        >
          {/* Nombre Completo*/}
          <TableSortLabel
            active={orderBy === "ID_AREA"}
            direction={orderBy === "ID_AREA" ? order : 'asc'}
            onClick={createSortHandler("ID_AREA")}
          >
            ID_AREA
            {orderBy === "ID_AREA" ? (
...
export default function TablaArea(props: any) {

  //console.log("rec prodiedad ", props.lista)
  const {loadApiCambioEstado} = useArea()
  const { tableData, deleteByIndex, loadObtenerListaAreas }: any = props;
