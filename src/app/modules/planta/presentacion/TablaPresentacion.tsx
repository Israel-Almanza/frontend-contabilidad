...
import { ModalActivarPresentacion } from "./components/ModalActivar";
import { ModalDesactivarPresentacion } from "./components/ModalDesactivar";
...
//const rows = 'calories';
const DEFAULT_ORDER_BY = 'ID_PRESENTACION';
    ...
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        >
          {/* Nombre Completo*/}
          <TableSortLabel
            active={orderBy === "ID_PRESENTACION"}
            direction={orderBy === "ID_PRESENTACION" ? order : 'asc'}
            onClick={createSortHandler("ID_PRESENTACION")}
          >
            ID_PRESENTACION
        ...
        <TableCell sx={{ ...tableStyling, width: '50%', minWidth: '60px', borderLeft: "1px solid white" }} align="center">
          NOMBRE PRESENTACION
          <TableSortLabel
        ...
        <TableCell sx={{ ...tableStyling, width: '25%', borderLeft: "1px solid white" }} align="center">
          ESTADO
          <TableSortLabel
...
export default function TablaPresentacion(props: any) {

  //console.log("rec prodiedad ", props.lista)
  const { tableData, deleteByIndex, loadObtenerListaPresentacion }: any = props;
  ...
  const [ID_PRESENTACIONP, setID_PRESENTACION] = useState('')


  const pasarParametrosActivar = (row: any) => {
    const { ID_PRESENTACION } = row;
    console.log("row ", row)
  ...
  return (
    <div>
      ...
      <ModalActivarPresentacion
        ...
        ID_PRESENTACION={ID_PRESENTACIONP}
        loadObtenerListaPresentacion={loadObtenerListaPresentacion}
        />

        <ModalDesactivarPresentacion
