...
//const rows = 'calories';
const DEFAULT_ORDER_BY = 'ID_PRODUCTO';
  ...
  return (
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        <TableCell sx={{ ...tableStyling, width: '30%', minWidth: '60px', borderLeft: "1px solid white" }} align="center">
          PRODUCTO
          <TableSortLabel
            active={orderBy === "CI"}
...
export default function TablaPlantaProducto(props: any) {
