...
export const ModalEditarProducto = (props:any) => {
    ...
    useEffect(() => {
        setValue('tamaño', DatosTabla?.id_tam)
        setValue('Costo_Sucursales',0)
        setValue('Pedidos_Ya',0)
        setValue('Costo_Yaigo',0)
        setValue('Costo_Ser',0)
        setValue('Costo_Cortesias',0)
        setValue('Costo_Reposiciones',0)
        setValue('Consumo_interno',0)
        setValue('Costo_Desperdicios',0)
        setValue('Fexco_Ventas',0)
        setValue('Fexco_Cortesias',0)
        setValue('Fexco_Merienda',0)
        setValue('Fexco_Consumo_Crédito',0)
        setValue('Fexco_Desperdicio',0)
    ...
    const handleSaveSubCategoria = async () => {
     ...
     const addNewElement = (data: any) => {
         ...
         updateTextModal(ultimoDato?.ID_TAMAÑO,ultimoDato?.TAMAÑO, tamaño, 
