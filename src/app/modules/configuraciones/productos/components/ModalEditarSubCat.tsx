...
export const ModalEditarSubCat = (props:any) => {

    const {loadApiEditarSubCategoria} = useProducto()
    const { handleSubmit, control,setValue, getValues, register } = useForm();
    const {openModalEditarSubCate,handleOpenModalEditarSubCate ,handleCloseModalEditarSubCate,
        loadObtenerSegundaCategoria, nomPrimeraCat, idPrimeraCat,  idSegundaCat,
        nomSegundaCat} = props;
    ...
    useEffect(() => {
        ...
        //EditarUsuario()
        setValue("SubcategoriaNew",nomSegundaCat)
    ...
    const handleEditarSubCategoria = async (data:any) => {
        if ( !idSegundaCat) {
        ...
        try {
            ...
            setLoading(true)
            const response:any = await loadApiEditarSubCategoria(
                
                Number(idSegundaCat),
                data.SubcategoriaNew,
                )
            console.log("save editado sub categoria ", response)
            closeModalResetForm()
            setLoading(false)
            if (response?.status) {
      ...
      const closeModalResetForm = () => {
        ...
        setValue("SubcategoriaNew",'')
        handleCloseModalEditarSubCate()
    }
        ...
        >
            ...
            <div style={{
                ...
                <div style={{ margin:'15px' }}>
                    ...
                    <div>
                        <h4 style={{ margin: "2px" }}>Segunda Categoria:</h4>
                        <Controller
                                name="SubcategoriaNew"
                                control={control}
                    ...
                    <ColorButton variant="contained" onClick={handleSubmit(handleEditarSubCategoria)}> Modificar</ColorButton>
