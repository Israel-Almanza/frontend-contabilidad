...
export const ModalAgregarSubCat = (props:any) => {

    const {loadApiGuardarSubCategoria} = useProducto()
    const {openModalSubCategoria,handleOpenModalSubCategoria ,handleCloseModalSubCategoria, nomPrimeraCat, loadObtenerSegundaCategoria, idPrimeraCat} = props;
