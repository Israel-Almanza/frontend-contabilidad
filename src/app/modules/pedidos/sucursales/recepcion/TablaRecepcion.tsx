...
export default function TablaRecepcion(props: any) {
  ...
  const InputTextFieldSmall = ({ control, isRequired = false, nameRegister, isDisable, index }: any) => {
    ...
    const handleIsDisable = () => {
      var localestaDesabilitado = localStorage.getItem('estaDesabilitado_recepcion'); //string true // false
                ...
                <TableRow key={row.ID_SUB_CATEGORIA_2}>
                  ...
                  >
                    <InputNumberFieldSmall
                      ...
                      isRequired={false}
                      //nameRegister="demo"
                      nameRegister={`${row.ID_SUB_CATEGORIA_2}_aceptada`}
                  ...
                  >
                    ...
                    <InputTextFieldSmall
                      ...
                      isDisable={false}
                      //isDisable={controlDisable == 13 ? true : false}
                      //variant="filled"
                      control={control}
                      isRequired={false}
