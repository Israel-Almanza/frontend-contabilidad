...
import PaletaChildRevisionPedido from './PaletaChildRevisionPedido';
//import { usePerfilPedido } from '../services/usePerfilPedido';

const PaletaRevisionPedido = (props: any) => {
  const { name, color, COLOR_R, COLOR_G, COLOR_B, SUBCATEGORIA, control,getValues
,solicitada,errors,setValue, enviada,
register, adecuacionInput} = props;
...
export default PaletaRevisionPedido
