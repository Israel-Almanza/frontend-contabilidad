...
import TablaPerfilPedido from '../TablaPerfilPedido';

const PaletaChildPerfilPedido = (props: any) => {
  const {  COLOR_R, COLOR_G, COLOR_B, SUB_CATEGORIA_1, PRODUCTOS, control,getValues,adecuacionInput
} = props;
  ...
  return (
    <>
      ...
      {PRODUCTOS ?
        <Collapse in={openOne} timeout="auto" unmountOnExit>
          <div style={{ margin: 'auto', width: '96%' }}>
            <TablaPerfilPedido COLOR_R={COLOR_R} COLOR_G={COLOR_G} COLOR_B={COLOR_B}
             PRODUCTOS={PRODUCTOS} 
...
export default PaletaChildPerfilPedido
