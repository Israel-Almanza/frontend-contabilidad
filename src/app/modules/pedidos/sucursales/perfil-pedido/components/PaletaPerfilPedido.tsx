...
import PaletaChildPerfilPedido from './PaletaChildPerfilPedido';
import { usePerfilPedido } from '../services/usePerfilPedido';

const PaletaPerfilPedido = (props: any) => {
  const { name, color, COLOR_R, COLOR_G, COLOR_B, SUBCATEGORIA, control,getValues,adecuacionInput
} = props;
  ...
  if(name=="Salados"){
    console.log("okkkkkkkkkkkkkkkkkk ",name,COLOR_R, COLOR_G, COLOR_B)
...
export default PaletaPerfilPedido
