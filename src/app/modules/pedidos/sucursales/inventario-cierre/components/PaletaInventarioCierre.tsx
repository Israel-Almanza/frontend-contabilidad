...
import PaletaChildInventarioCierre from './PaletaChildInventarioCierre';

const PaletaInventarioCierre = (props: any) => {
  const { name, color, COLOR_R, COLOR_G, COLOR_B, SUBCATEGORIA, STOCK, control, cabecera,controlDisable, getValues, adecuacionInput } = props;
  ...
  return (
    <>
      <div style={{
        ...
        , alignItems: 'center', marginLeft:'0.5%'
...
export default PaletaInventarioCierre
