...
import TablaEntregas from '../TablaEntrega';

const PaletaChildEntrega = (props: any) => {
  const { name, color, COLOR_R, COLOR_G, COLOR_B ,SUB_CATEGORIA_1,PRODUCTOS, STOCK,control, controlDisable, registro, precargado,getValues,aceptada,adecuacionInput} = props;
    ...
    <>
      ...
      {PRODUCTOS ? 
       ...
       <div style={{ margin: 'auto', width: '96%' }}>
        <TablaEntregas COLOR_R={COLOR_R} COLOR_G={COLOR_G} COLOR_B={COLOR_B}  PRODUCTOS={PRODUCTOS} STOCK={STOCK} 
        control={control}
        registro={registro}
        aceptada={aceptada}
