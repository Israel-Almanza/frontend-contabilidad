...
const PaletaChildSolicitudes = (props: any) => {
    ...
    <>
      ...
      {PRODUCTOS ? 
       ...
       <div style={{ margin: 'auto', width: '96%' }}>
        <TablaSolicitudes COLOR_R={COLOR_R} COLOR_G={COLOR_G} COLOR_B={COLOR_B}  PRODUCTOS={PRODUCTOS} STOCK={STOCK} 
        control={control}
        registro={registro}
...
export default PaletaChildSolicitudes