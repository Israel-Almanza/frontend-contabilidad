...
export const ModalPersonalized2 = (props:any) => {
  ...
  const handleChange = (event: any) => {
    ...
    const {openModalPersonalized,handleOpenModalPersonalized ,handleCloseModalPersonalized,handleBuscarPerfil} = props;
          ...
          {genders.map(option => (
            <MenuItem key={option.value} value={option.value}>
              {option.label}
                ...
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                    <Button sx={{ backgroundColor: '#43A047' }} variant="contained" onClick={handleBuscarPerfil}>Si</Button>
                    &nbsp; &nbsp;
