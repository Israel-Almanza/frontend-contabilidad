...
export const ModalEditarSubCatInventario = (props:any) => {

    const {loadApiEditarSubCategoriaInventario} = useProductosInventario()
    ...
    const {openModalEditarSubCate,handleOpenModalEditarSubCate ,handleCloseModalEditarSubCate,
        loadObtenerSubCategoria, nomPrimeraCat, idPrimeraCat,  idSegundaCat,
        nomSegundaCat} = props;
    ...
    const handleEditarSubCategoria = async (data:any) => {
        ...
        try {
            ...
            setLoading(true)
            const response:any = await loadApiEditarSubCategoriaInventario(
