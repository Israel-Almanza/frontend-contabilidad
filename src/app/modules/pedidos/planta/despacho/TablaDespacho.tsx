...
export default function TablaDespacho(props: any) {
                ...
                return (<TableRow key={index}>
                  {
                    column.map((v: any, indexDimanic: number) => {
                      ...
                      if (v == "RECIBIDA") {
                        ...
                        //console.log("americ", row[`${(v).replace(" ", "_")}`])
                        //console.log("row ",row.ID_SUB_CATEGORIA_2)
                        return (
                          <TableCell
                            key={indexDimanic}
                            sx={{
                          ...
                          >
                            <InputNumberFieldSmall
                              ...
                              isRequired={false}
                              //nameRegister="demo"
                              nameRegister={`${row.ID_SUB_CATEGORIA_2}_recibida`}
                              index={index}
                            />
                          </TableCell>
                        ...
                        return (
                          ...
                          >
                            <CheckBoxCustom
                              ...
                              isRequired={false}
                              //nameRegister="demo"
                              nameRegister={`${row.ID_SUB_CATEGORIA_2}_cargado`}
                              index={index}
                            />
                          </TableCell>
                        )
                      ...
                      return (
                        ...
                        >
                          {/*row.grupo*/}
                          {v == "America Oeste" || v == "America Este" || v == "Mega Center" ?
                            row[`${(v).replace(" ", "_")}`]
                            : row[v]}
