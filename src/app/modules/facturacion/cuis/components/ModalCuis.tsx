...
export const ModalMostrarCuis = (props:any) => {

    const {openModalCuis,handleOpenModalCuis, handleCloseModalCuis,Cuis} = props;
console.log("respuesta ",Cuis)
