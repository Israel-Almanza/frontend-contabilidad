...
export const ModalActivarLlave = (props:any) => {
    const { loadApiActivarLlave} = useLlave()
    const {openModalEstadoA,handleOpenModalEstadoA ,handleCloseModalEstadoA, Id_Llave ,loadObtenerListaLlaves} = props;
...
const loadActivar = async () => {
    ...
    try {
      const response = await loadApiActivarLlave(
        Id_Llave
      );
        ...
        >
            <Box sx={styleModal}>
                ...
                <Typography id="modal-modal-description" sx={{
                   ...
                   ¿Esta seguro de Habilitar la Llave?
                </Typography>
                <br />
