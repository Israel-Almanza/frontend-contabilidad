...
export const ModalDesactivarLlave = (props:any) => {
    const { loadApiDesactivarLlave} = useLlave()
    const {openModalEstadoDes,handleOpenModalEstadoDes ,handleCloseModalEstadoDes, Id_Llave,loadObtenerListaLlaves} = props;
...
const loadDesactivar = async () => {
    ...
    try {
      const response = await loadApiDesactivarLlave(
        Id_Llave
      );
        ...
        >
            <Box sx={styleModal}>
                ...
                <Typography id="modal-modal-description" sx={{
                   ...
                   ¿Esta seguro de Inabilitar la Llave?
                </Typography>
                <br />
