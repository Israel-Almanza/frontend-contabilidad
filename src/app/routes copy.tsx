...
import BorrarUsuarioPage from '../pages/usuarios-x/BorrarUsuarioPage';
import AccessibilidadPage from '../pages/usuarios-x/AccessibilidadPage';
...
const usuariosRoutes = [
  ...
  // { path: '/accesibilidad', element: < AccessibilidadPage /> },
  { path: '/delete-usuario', element: < BorrarUsuarioPage /> },
